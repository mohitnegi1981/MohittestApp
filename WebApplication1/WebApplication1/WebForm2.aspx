...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowModal() {
            var ret = window.showModalDialog('WebForm1.aspx, "mywindow","");
            return false;
...
<body>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" OnClientClick="return ShowModal();" Text="Button" />
